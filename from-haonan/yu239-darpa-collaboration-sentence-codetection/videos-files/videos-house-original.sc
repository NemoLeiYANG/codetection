(("/net/zhineng/aux/yu239/house/00000-000001-000003-bowl.avi"
 ...
 ;; ("/net/zhineng/aux/yu239/house/00000-000025-000005-pineapple.avi"
 ;;  ((v moved #(person 0) #(pineapple 0))
 ;;   (p near-end #(pineapple 0) #(squash 0)))
 ;;  "the person put the pineapple near the squash")
 ;; ("/net/zhineng/aux/yu239/house/00000-000034-000003-squash.avi"
 ;;  ((v moved #(person 0) #(squash 0))
 ;;   (p away-from #(squash 0) #(pineapple 0))
 ;;   (p near-end #(squash 0) #(cabbage 0)))
 ;;  "the person took the squash away from the pineapple and put it near the cabbage")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00000-000128-000004-cabbage.avi"
 ;;  ((v put-down #(person 0) #(cabbage 0))
 ;;   (p to-the-right-of-start #(cabbage 0) #(cleaner 0)))
 ;;  "the person put the cabbage to the right of the cleaner into the sink")
 ...
 ("/net/zhineng/aux/yu239/house/00000-000332-000003-pineapple.avi"
  ((v put-down #(person 0) #(pineapple 0))
   (p below-end  #(pineapple) #(coffee)))
  "the person put the pineapple into the sink below the coffee")
 ;; ("/net/zhineng/aux/yu239/house/00000-000335-000004-cabbage.avi"
 ;;  ((v put-down #(person 0) #(cabbage 0))
 ;;   (p to-the-left-of-end #(cabbage 0) #(pineapple 0)))
 ;;  "the person put the cabbage into the sink to the left of the pineapple")
...
;;;;;;;;;;;;;;;;;; scene 00001 ;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 ;; ("/net/zhineng/aux/yu239/house/00003-000024-000005-wine.avi"
 ;;  ((p above-any #(wine 0) #(cup 0))
 ;;   (v rotated #(person 0) #(wine 0)))
 ;;  "the person poured the wine into the cup")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00003-000048-000004-cup.avi"
 ;;  ((p above-any #(cup 0) #(cup 1))
 ;;   (v rotated #(person 0) #(cup 0)))
 ;;  "the person poured the water from one cup to another")
 ...
 ("/net/zhineng/aux/yu239/house/00003-000118-000004-ketchup.avi"
  ((p above-any #(ketchup 0) #(cup 0))
   (v rotated #(person 0) #(ketchup 0)))
  "the person poured the ketchup into the cup")
 ;; ("/net/zhineng/aux/yu239/house/00003-000124-000004-cup.avi"
 ;;  ((p above-any #(cup 0) #(cup 1))
 ;;   (v rotated #(person 0) #(cup 0)))
 ;;  "the person poured the water from one cup into another")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00003-000219-000004-cup.avi"
 ;;  ((p above-any #(cup 0) #(cup 1))
 ;;   (v rotated #(person 0) #(cup 0)))
 ;;  "the person poured the water from one cup into another")
 ;; ("/net/zhineng/aux/yu239/house/00003-000240-000004-cup.avi"
 ;;  ((p above-any #(cup 0) #(cup 1))
 ;;   (p to-the-right-of-start #(cup 0) #(juice 0))
 ;;   (v rotated #(person 0) #(cup 0))
 ;;   (p to-the-left-of #(cup 1) #(ketchup 0)))
 ;;  "the person poured the water from one cup which is to the right of the juice into the cup which is to the left of the ketchup")
 ("/net/zhineng/aux/yu239/house/00003-000245-000004-ketchup.avi"
  ((p above-any #(ketchup 0) #(cup 0))
   (v rotated #(person 0) #(ketchup 0)))
  "the person added some ketchup into the cup")
 ;; ("/net/zhineng/aux/yu239/house/00003-000259-000004-wine.avi"
 ;;  ((p above-any #(wine 0) #(cup 0))
 ;;   (v rotated #(person 0) #(wine 0)))
 ;;  "the person poured some wine into the cup")
 ("/net/zhineng/aux/yu239/house/00003-000306-000004-juice.avi"
  ((p above-any #(juice 0) #(cup 0))
   (v rotated #(person 0) #(juice 0)))
  "the person poured some juice into the cup")
 ;; ("/net/zhineng/aux/yu239/house/00003-000313-000003-cup.avi"
 ;;  ((p above-any #(cup 0) #(cup 1))
 ;;   (v rotated #(person 0) #(cup 0)))
 ;;  "the person poured the water from one cup into another")
 ;; ("/net/zhineng/aux/yu239/house/00003-000328-000004-wine.avi"
 ;;  ((p to-the-left-of-start #(wine 0) #(ketchup 0))
 ;;   (v rotated #(person 0) #(wine 0)))
 ;;  "the person poured the wine to the left of the ketchup")
 ...
 ("/net/zhineng/aux/yu239/house/00003-000346-000003-ketchup.avi"
  ((p to-the-right-of-start #(ketchup 0) #(milk 0))
   (v rotated #(person 0) #(ketchup 0)))
  "the person poured the ketchup to the right of the mlik")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00003-000451-000005-wine.avi"
 ;;  ((p above-any #(wine 0) #(cup 0))
 ;;   (v rotated #(person 0) #(wine 0))
 ;;   (p to-the-left-of #(cup 0) #(cup 1)))
 ;;  "the person added some wine into the cup on the left")
 ("/net/zhineng/aux/yu239/house/00003-000459-000004-ketchup.avi"
  ((p above-any #(ketchup 0) #(cup 0))
   (v rotated #(person 0) #(ketchup 0))
   (p to-the-left-of #(cup 0) #(cup 1)))
  "the person added some ketchup into the cup on the left")
 ("/net/zhineng/aux/yu239/house/00003-000508-000005-milk.avi"
  ((p above-any #(milk 0) #(cup 0))
   (v rotated #(person 0) #(milk 0))
   (p to-the-left-of #(cup 0) #(cup 1)))
  "the person added some milk into the cup on the left")
 ("/net/zhineng/aux/yu239/house/00003-000518-000004-juice.avi"
  ((p above-any #(juice 0) #(cup 0))
   (v rotated #(person 0) #(juice 0))
   (p to-the-right-of #(cup 0) #(cup 1)))
  "the person added some juice into the cup on the right")
 ;; ("/net/zhineng/aux/yu239/house/00003-000525-000003-cup.avi"
 ;;  ((p above-any #(cup 0) #(cup 1))
 ;;   (v rotated #(person 0) #(cup 0))
 ;;   (p to-the-left-of #(cup 0) #(cup 1)))
 ;;  "the person poured some water from the cup into the cup on the right")
 ;; ("/net/zhineng/aux/yu239/house/00003-000529-000003-cup.avi"
 ;;  ((p above-any #(cup 0) #(cup 1))
 ;;   (v rotated #(person 0) #(cup 0))
 ;;   (p to-the-right-of #(cup 0) #(cup 1)))
 ;;  "the person poured some water from the cup into the cup on the left")
 ("/net/zhineng/aux/yu239/house/00003-000540-000003-milk.avi"
  ((p above-any #(milk 0) #(cup 0))
   (v rotated #(person 0) #(milk 0))
   (p to-the-right-of #(cup 0) #(cup 1)))
  "the person added some milk into the cup on the right")
 ("/net/zhineng/aux/yu239/house/00003-000548-000002-ketchup.avi"
  ((p above-any #(ketchup 0) #(cup 0))
   (v rotated #(person 0) #(ketchup 0))
   (p to-the-right-of #(cup 0) #(cup 1)))
  "the person added some ketchup into the cup on the right")
 ;; ("/net/zhineng/aux/yu239/house/00003-000554-000005-wine.avi"
 ;;  ((p above-any #(wine 0) #(cup 0))
 ;;   (v rotated #(person 0) #(wine 0))
 ;;   (p to-the-right-of #(cup 0) #(cup 1)))
 ;;  "the person added some wine into the cup on the right")
 ("/net/zhineng/aux/yu239/house/00003-000600-000004-juice.avi"
  ((p above-any #(juice 0) #(cup 0))
   (v rotated #(person 0) #(juice 0))
   (p to-the-left-of #(cup 0) #(cup 1)))
  "the person added some juice into the cup on the left")
 ;; scene 5
 ...
 ("/net/zhineng/aux/yu239/house/00004-000028-000003-cooler.avi"
  ...
  "the person lifted the cooler on the right")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00004-000116-000002-toy.avi"
 ;;  ((v put-down #(person 0) #(toy 0))
 ;;   (p to-the-right-of-start #(toy 0) #(cooler 0)))
 ;;  "the person put down the toy to the right of the cooler")
 ;; ("/net/zhineng/aux/yu239/house/00004-000128-000003-toy.avi"
 ;;  ((v picked-up #(person 0) #(toy 0))
 ;;   (p to-the-right-of-start #(toy 0) #(cooler 0)))
 ;;  "the person picked up the toy to the right of the cooler")
 ("/net/zhineng/aux/yu239/house/00004-000156-000002-cooler.avi"
  ((v moved #(person 0) #(cooler 0))
   (p on-top-of-end #(cooler 0) #(cooler 1)))
  "the person stacked the cooler onto another")
 ("/net/zhineng/aux/yu239/house/00004-000158-000004-cooler.avi"
  ((v put-down #(person 0) #(cooler 0))
   (p on-top-of-end #(cooler 0) #(cooler 1)))
  "the person put down the cooler on top of another")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00004-000251-000003-toy.avi"
 ;;  ((v moved #(person 0) #(toy 0))
 ;;   (p on-top-of-end #(toy 0) #(box 0)))
 ;;  "the person stacked the toy onto the box")
 ...
 ("/net/zhineng/aux/yu239/house/00005-000029-000002-box.avi"
  ...
  "the person lifted the box which is to the right of the toy")
 ("/net/zhineng/aux/yu239/house/00005-000032-000003-cooler.avi"
  ((v picked-up #(person 0) #(cooler 0))
   (p on-top-of-end #(cooler 0) #(box 0)))
  "the person lifted the cooler and stacked it onto the box")
 ;; ("/net/zhineng/aux/yu239/house/00005-000041-000003-toy.avi"
 ;;  ((v put-down #(person 0) #(toy 0)))  
 ;;  "the person put down the toy on the ground")
 ;; ("/net/zhineng/aux/yu239/house/00005-000044-000002-toy.avi"
 ;;  ((v moved #(person 0) #(toy 0))
 ;;   (p on-top-of-end #(toy 0) #(cooler)))  
 ;;  "the person stacked the toy onto the cooler")
 ;; ("/net/zhineng/aux/yu239/house/00005-000057-000002-toy.avi"
 ;;  ((v picked-up #(person 0) #(toy 0)))
 ;;  "the person picked up the toy")
 ("/net/zhineng/aux/yu239/house/00005-000100-000002-cooler.avi"
  ((v picked-up #(person 0) #(cooler 0)))
  "the person picked up the cooler")
 ;; ("/net/zhineng/aux/yu239/house/00005-000107-000003-toy.avi"
 ;;  ((v put-down #(person 0) #(toy 0))
 ;;   (p to-the-right-of-start #(toy 0) #(cooler 0)))
 ;;  "the person put down the toy to the right of the cooler")
 ;; ("/net/zhineng/aux/yu239/house/00005-000110-000004-toy.avi"
 ;;  ((v moved #(person 0) #(toy 0))
 ;;   (p on-top-of-end #(toy 0) #(cooler 0)))
 ;;  "the person stacked the toy onto the cooler")
 ;; ("/net/zhineng/aux/yu239/house/00005-000126-000003-toy.avi"
 ;;  ((v put-down #(person 0) #(toy 0)))  
 ;;  "the person put down the toy on the ground")
 ;; ("/net/zhineng/aux/yu239/house/00005-000142-000003-toy.avi"
 ;;  ((v picked-up #(person 0) #(toy 0))
 ;;   (p to-the-left-of-end #(toy 0) #(cooler 0)))
 ;;  "the person picked up the toy and put it to the left of the cooler")
 ...
 ("/net/zhineng/aux/yu239/house/00005-000641-000003-cooler.avi"
  ((v put-down #(person 0) #(cooler 0)))
  "the person put down the cooler")
 ;; ("/net/zhineng/aux/yu239/house/00005-000814-000003-toy.avi"
 ;;  ((v moved #(person 0) #(toy 0))
 ;;   (p on-top-of-end #(toy 0) #(cooler 0)))
 ;;  "the person stacked the toy onto the cooler")
 ;; ("/net/zhineng/aux/yu239/house/00006-000019-000002-toy.avi"
 ;;  ((v put-down #(person 0) #(toy 0)))
 ;;  "the person put down the toy")
 ("/net/zhineng/aux/yu239/house/00006-000027-000003-box.avi"
  ((v put-down #(person 0) #(box 0))
   ;;(p to-the-right-of-start #(box 0) #(toy 0))
   )
  "the person put down the box to the right of the toy")
 ;; ("/net/zhineng/aux/yu239/house/00006-000033-000002-toy.avi"
 ;;  ((v moved #(person 0) #(toy 0))
 ;;   (p on-top-of-end #(toy 0) #(cooler 0)))
 ;;  "the person stacked the toy onto the cooler")
 ...
 ("/net/zhineng/aux/yu239/house/00006-000049-000002-cooler.avi"
  ...
  "the person carried the cooler rightwards")
 ;;;;;;;;;;;;;;;;;;;;;;;;; scene 00007 ;;;;;;;;;;;;;;;;;;;;;;;;;;;
 ;; ("/net/zhineng/aux/yu239/house/00007-000219-000003-vacuum.avi"
 ;;  ((v picked-up #(person 0) #(vacuum 0)))
 ;;  "the person loaded the vacuum into the trunk")
 ;; ("/net/zhineng/aux/yu239/house/00007-000222-000004-vacuum.avi"
 ;;  ((v put-down #(person 0) #(vacuum 0)))
 ;;  "the person unloaded the vacuum from the trunk")
 ;;;;;;;;;;;;;;;;;;;;;;;;; scene 00008 ;;;;;;;;;;;;;;;;;;;;;;;;;;
 ;; ("/net/zhineng/aux/yu239/house/00008-000006-000003-saw.avi"
 ;;  ((v put-down #(person 0) #(saw 0)))
 ;;  "the person unloaded the saw from the trunk")
 ;; ("/net/zhineng/aux/yu239/house/00008-000009-000002-saw.avi"
 ;;  ((v picked-up #(person 0) #(saw 0)))
 ;;  "the person loaded the saw into the trunk")
 ...
 ("/net/zhineng/aux/yu239/house/00008-000017-000002-watering-pot.avi"
  ((v put-down #(person 0) #(watering-pot 0))
   ;;(p near-end #(watering-pot 0) #(vacuum 0))
   )
  "the person unloaded the watering-pot from the trunk and put it near the vacuum")
 ;; ("/net/zhineng/aux/yu239/house/00008-000041-000002-paper-bag.avi"
 ;;  ((v put-down #(person 0) #(paper-bag 0)))
 ;;  "the person took the paper-bag out from the trunk")
 ;; ("/net/zhineng/aux/yu239/house/00008-000043-000002-paper-bag.avi"
 ;;  ((v picked-up #(person 0) #(paper-bag 0)))
 ;;  "the person put the paper-bag into the trunk")
 ...
 ("/net/zhineng/aux/yu239/house/00008-000102-000003-bucket.avi"
  ((v picked-up #(person 0) #(bucket 0))
   ;;(p to-the-left-of-end #(bucket 0) #(paper-bag))
   )
  "the person picked up the bucket and put it to the left of the paper-bag")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00008-000130-000002-saw.avi"
 ;;  ((v put-down #(person 0) #(saw 0)))
 ;;  "the person put down the saw")
 ;; ("/net/zhineng/aux/yu239/house/00008-000132-000003-saw.avi"
 ;;  ((v picked-up #(person 0) #(saw 0)))
 ;;  "the person picked up the saw")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00008-000208-000002-saw.avi"
 ;;  ((v put-down #(person 0) #(saw 0))
 ;;   (p to-the-right-of-start #(saw 0) #(bucket 0)))
 ;;  "the person put down the saw to the right of the bucket")
 ("/net/zhineng/aux/yu239/house/00008-000218-000002-gas-can.avi"
  ((v put-down #(person 0) #(gas-can 0)))  
  "the person unloaded the gas-can from the trunk")
 ;; ("/net/zhineng/aux/yu239/house/00008-000255-000002-saw.avi"
 ;;  ((v carried-leftwards #(person 0) #(saw 0)))
 ;;  "the person carried the saw leftwards")
 ;; ("/net/zhineng/aux/yu239/house/00008-000258-000002-saw.avi"
 ;;  ((v carried-rightwards #(person 0) #(saw 0)))
 ;;  "the person carried the saw rightwards")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00008-000333-000004-paper-bag.avi"
 ;;  ((v picked-up #(person 0) #(paper-bag 0))
 ;;   (p to-the-right-of-end #(paper-bag 0) #(gas-can 0)))
 ;;  "the person picked up the paper-bag and put it to the right of the gas-can")
 ("/net/zhineng/aux/yu239/house/00008-000337-000002-gas-can.avi"
  ((v put-down #(person 0) #(gas-can 0))
   ;;(p near-start #(gas-can 0) #(paper-bag 0))
   )
  "the person unloaded the gas-can which is near the paper-bag from the trunk")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00008-000411-000003-saw.avi"
 ;;  ((v picked-up #(person 0) #(saw 0))
 ;;   (p to-the-right-of-start #(saw 0) #(vacuum 0))
 ;;   )
 ;;  "the person lifted the saw to the right of the vacuum")
 ;; ("/net/zhineng/aux/yu239/house/00008-000414-000004-vacuum.avi"
 ;;  ((v picked-up #(person 0) #(vacuum 0)))  
 ;;  "the person picked up the vacuum")
 ;; ("/net/zhineng/aux/yu239/house/00008-000420-000002-vacuum.avi"
 ;;  ((v put-down #(person 0) #(vacuum 0)))
 ;;  "the person put down the vacuum")
 ;; ("/net/zhineng/aux/yu239/house/00008-000422-000004-saw.avi"
 ;;  ((v put-down #(person 0) #(saw 0))
 ;;   (p near-end #(saw 0) #(vacuum 0))
 ;;   )
 ;;  "the person unloaded the saw from the trunk and put it near the vacuum")
 ("/net/zhineng/aux/yu239/house/00008-000439-000002-watering-pot.avi"
  ((v picked-up #(person 0) #(watering-pot 0))
   (p to-the-left-of-start #(watering-pot 0) #(bucket 0)))
  "the pesron picked up the watering-pot to the left of the bucket")
 ;; ("/net/zhineng/aux/yu239/house/00008-000444-000003-paper-bag.avi"
 ;;  ((v picked-up #(person 0) #(paper-bag 0)))  
 ;;  "the person loaded the paper-bag into the trunk")
 ("/net/zhineng/aux/yu239/house/00008-000449-000002-watering-pot.avi"
  ((v put-down #(person 0) #(watering-pot 0))
   ;;(p to-the-left-of-start #(watering-pot 0) #(paper-bag 0))
   )
  "the person put down the watering-pot to the left of the paper-bag")
 ;; ("/net/zhineng/aux/yu239/house/00008-000451-000003-paper-bag.avi"
 ;;  ((v put-down #(person 0) #(paper-bag 0))
 ;;   (p to-the-right-of-start #(paper-bag 0) #(watering-pot 0)))  
 ;;  "the person put down the paper-bag to the right of the watering-pot")
 ...
 ;; ("/net/zhineng/aux/yu239/house/00008-000706-000002-vacuum.avi"
 ;;  ((v put-down #(person 0) #(vacuum 0)))
 ;;  "the person put down the vacuum")
 )