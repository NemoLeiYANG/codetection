...
//typedef opengm::SparseMarray<double> SparseFunction;
typedef opengm::SparseFunction<double,size_t,size_t> SparseFunction;
//typedef opengm::SparseFunction<double,double,double> SparseFunction;//,std::map<size_t, double> > SparseFunction; //for g??
//typedef opengm::SparseMarray<std::map<size_t, double>> SparseFunction; //for g??
