...
(define (box-vector-at-height-and-pose->world-corners box-vector height robot-pose
						      intrinsics camera-offset-matrix)
	 ;;x1 y1 x2 y2 camera->world intrinsics height)
 (let* ((camera->world
...
;; (dtrace "bottom-left bottom-right top-left"
;; 	(list world-bottom-left world-bottom-right world-top-left))
  (list world-top-left world-bottom-right)))
