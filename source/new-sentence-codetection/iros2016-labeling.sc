...
(define tables-full-6 (build-table-matrix asm-3with4-8 6)) ;;1 label per object class
(define tables-full-7 (build-table-matrix asm-3with4-8 7))
(define tables-full-8 (build-table-matrix asm-3with4-8 8))
(define tables-full-9 (build-table-matrix asm-3with4-8 9))
(define tables-full-10 (build-table-matrix asm-3with4-8 10))
(define tables-full-11 (build-table-matrix asm-3with4-8 11))
(define tables-full-12 (build-table-matrix asm-3with4-8 12))
...
(define msv-full-6 (compute-max-score-vec tables-full-6 num-peaks))
(define msv-full-7 (compute-max-score-vec tables-full-7 num-peaks))
(define msv-full-8 (compute-max-score-vec tables-full-8 num-peaks))
(define msv-full-9 (compute-max-score-vec tables-full-9 num-peaks))
(define msv-full-10 (compute-max-score-vec tables-full-10 num-peaks))
(define msv-full-11 (compute-max-score-vec tables-full-11 num-peaks))
(define msv-full-12 (compute-max-score-vec tables-full-12 num-peaks))
...
;; ;;functions for branch and bound--CHANGED IN branch-and-bound.sc
