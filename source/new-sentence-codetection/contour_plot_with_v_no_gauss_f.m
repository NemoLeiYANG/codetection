function contour_plot_with_v_no_gauss_f(detection_data,ground_truth,output_path)
...
%WITH visibility measure, no proposal score, no gaussian distance
[numpeaks, peakxys,scores_out] = find_objects_with_v_no_gauss_f(detection_data, xmin,xmax, ymin, ymax, cm_between, gaussian_variance);
...
contourname = sprintf('%s/contour-8.png',output_path);
title(contourname);
