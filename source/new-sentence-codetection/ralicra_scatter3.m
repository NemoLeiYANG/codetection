function ralicra_scatter3(detection_data, ground_truth, output_path)
...
scattername = sprintf('%s/all-scatter.png',output_path);
scattertitle = sprintf('Plot of All Non-penalized Proposals');
title(scattertitle);
