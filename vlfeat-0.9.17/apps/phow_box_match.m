...
% read its readme.txt
%addpath(genpath('/home/haonan/Programs/matlab/forests_edges_boxes'));
addpath(genpath('~/codetection/forests_edges_boxes'));
run('../toolbox/vl_setup');
% Load image
% change the image paths to yours
img1 = imread('~/codetection/training-videos/0-0016.jpg');
    %imread('/home/haonan/Desktop/gist_images/frame.png');
img2 = imread('~/codetection/training-videos/0-0030.jpg');
    %imread('/home/haonan/Desktop/gist_images/frame1.png');
imshow(img1);
b1 = round(getrect);
disp(b1);
